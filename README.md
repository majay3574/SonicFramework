...
### **Root Directory**
- **.github/workflows/** – Contains CI/CD configurations for automated test execution.
...
- **customFixtures/** – Contains custom Playwright fixtures to enhance test capabilities.
- **data/** – Stores test data in JSON or CSV format.
- **helpers/** – Utility functions for reusability across test scripts.
- **logins/** – Manages authentication flows and user session handling.
- **pages/** – Implements Page Object Model (POM) to separate UI interactions.
...
- **playwright.config.ts** – Stores Playwright configuration settings.
- **tsconfig.json** – Configures TypeScript compiler options.

## 3. Features
- **Playwright Integration**: Enables powerful web automation with multi-browser support.
- **Custom Fixtures**: Enhances Playwright’s capabilities with reusable test utilities.
...
- **Integrate CI/CD** to automate testing workflows.
